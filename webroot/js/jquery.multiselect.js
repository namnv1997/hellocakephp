...
(function($){
    var defaults = {
        ...
        showCheckbox       : true,  // display the checkbox to the frontend
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            // override with frontend defined maxHeight
                ...
                if( thisOption.hasOwnProperty('options') ) {
                    ...
                    for( var gKey in thisOption.options ) {
                        ...
                        if( updateSelect ) {
                            ...
                            // add custom frontend attributes
        ...
        _addOption: function( container, option ) {
            ...
            // add frontend defined attributes
